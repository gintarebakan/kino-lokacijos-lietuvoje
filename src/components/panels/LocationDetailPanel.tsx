    ...
    <aside aria-hidden={!isOpen} style={isMobile ? mobileStyle : desktopStyle}>
      ...
      {previousFilmDetailId && (
        <button
          ...
          style={{
            position: "absolute",
            top: previousCollectionId ? 50 : 12,
            left: 12,
            zIndex: 50,
            background: "rgba(0,0,0,0.6)",
            border: "1px solid #222",
        ...
        {data && (
          <>
            ...
            <div style={{ padding: "16px 20px 96px" }}>
              ...
              {/* Primary action row: Išsaugoti + Tinklapis */}
              <div style={{ display: "flex", gap: 8, marginTop: 14 }}>
                  ...
                  onClick={() => {
                    if (isBookmarked(data.slug)) {
                      ...
                      const coords = data.coordinates
                        ? (
                            data.coordinates as unknown as {
                              coordinates: number[];
                            }
                          ).coordinates
                        : [0, 0];
                ...
                {data.official_website_url && (
                  <a
                    href={data.official_website_url}
                    target="_blank"
...
>
          ...
          {data.street_view_url && (
            <ActionIconButton
              onClick={() => window.open(data.street_view_url!, "_blank")}
