...
export const createQueryClient = () => //sukuriama createQueryClient funkcija
  new QueryClient({ //kuri kiekvieną kartą ją iškvietus pagamins naują QueryClient
    defaultOptions: {//su mūsų nustatytomis numatytomus taisyklėmis
      queries: {
